...
CREATE TABLE oi_walls_notifications (
    id                  BIGSERIAL PRIMARY KEY,
    symbol              TEXT NOT NULL,
...
CREATE INDEX idx_oi_walls_notifications_symbol_time
    ON oi_walls_notifications (symbol, captured_at_bucket DESC);

CREATE TABLE oi_walls_backtest_runs (
    id                      BIGSERIAL PRIMARY KEY,
    symbol                  TEXT NOT NULL,
...
CREATE INDEX idx_oi_walls_backtest_runs_symbol_dates
    ON oi_walls_backtest_runs (symbol, start_date, end_date);

CREATE TABLE oi_walls_backtest_events (
    id                      BIGSERIAL PRIMARY KEY,
...
CREATE INDEX idx_oi_walls_backtest_events_run_time
    ON oi_walls_backtest_events (run_id, captured_at);
CREATE INDEX idx_oi_walls_backtest_events_symbol_time
